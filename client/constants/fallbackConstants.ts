 ...
 * Used when server is unavailable or during offline scenarios
 * These are the same constants served by the backend
 */
export const FALLBACK_CONSTANTS: Constants = {
  intents: [
    "Dating",
    "Casual Dating",
  ...
  lifestyleOptions: {
    ...
    smoking: ["Never", "Rarely", "Socially", "Often", "Very Often"],
