...
export default function Step1({ onValidityChange }: Step1Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Please enter your name, birthdate, gender, and pronouns</Text>
      ...
      <View style={styles.fieldContainer}>
        ...
        <TouchableOpacity style={styles.datePickerButton} onPress={handleDatePickerOpen}>
          <Text style={[styles.datePickerText, !profileData?.birthdate && { color: MUTED }]}>
        ...
        <DateTimePickerModal
          ...
          mode="date"
          date={profileData?.birthdate ? new Date(profileData.birthdate) : maxBirthdate}
      ...
      {/* Pronouns */}
      <View style={[styles.fieldContainer, { zIndex: getZIndex("pronouns", 1) }]}>
        ...
        <DropDownPicker<string>
          ...
          setValue={(callback) => {
            const val = typeof callback === "function" ? callback(profileData?.pronouns ?? "") : callback;
...
const styles = StyleSheet.create({
  container: { flex: 1, justifyContent: "center", paddingHorizontal: 24, paddingVertical: 32, backgroundColor: BACKGROUND },
  ...
  input: { width: "100%", padding: 16, backgroundColor: BACKGROUND, borderRadius: 12, borderWidth: 1, borderColor: "#e5e7eb", fontSize: 16, color: DARK },
  datePickerButton: { paddingVertical: 12, paddingHorizontal: 16, borderRadius: 12, borderWidth: 1, borderColor: "#e5e7eb", backgroundColor: BACKGROUND, alignItems: "center", justifyContent: "center" },
